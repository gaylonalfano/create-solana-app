...
- [#270](https://github.com/solana-foundation/create-solana-dapp/pull/270)
  [`081f4fb`](https://github.com/solana-foundation/create-solana-dapp/commit/081f4fb5d7fe534fb4641417d34ad9e413709668)
  Thanks [@rajanpanth](https://github.com/rajanpanth)! - Recover from a corrupt cached template archive: retry the
  download once and, if it is still corrupt, explain which cache directory to clear instead of failing with a bare
  `ZlibError`
